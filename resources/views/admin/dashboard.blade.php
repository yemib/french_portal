...
<div class="row pt-3">
    ...
    <div class="col-sm-3">
        ...
        <div class="card-box widget-chart-one gradient-info bx-shadow-lg">
            ...
            <div class="widget-chart-one-content text-right">
                <p class="text-white mb-0 mt-2">Supervisors</p>
                <h3 class="text-white">{{ $supervisor->count() }}</h3>
            </div>
        </div>
    ...
    <div class="col-sm-3">
        ...
        <div class="card-box widget-chart-one gradient-info bx-shadow-lg">
            ...
            <div class="widget-chart-one-content text-right">
                <p class="text-white mb-0 mt-2">Results Uploaders</p>
    ...
    <div class="col-sm-3">
        ...
        <div class="card-box widget-chart-one gradient-info bx-shadow-lg">
            ...
            <div class="widget-chart-one-content text-right">
                <p class="text-white mb-0 mt-2">Bursary</p>
                <h3 class="text-white">{{ $bursar->count() }}</h3>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="col-sm-8 col-md-9">
        ...
        <div class="card mb-3"  style="display: none !important;">
            <div class="card-header bg-dark text-white">
                <span class="mdi mdi-account-group"></span> Card Request
            </div>
            <div class="bg-white table-responsive">
