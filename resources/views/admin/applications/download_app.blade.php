...
@section("pdf_title", "Application Form for ".$application_form->full_name)
...
<img src="{{ public_path().'/storage/images/passport/'.$application_form->passport  }}"
                                       class="img-fluid img-rounded img-thumbnail" style="max-width: 100px; max-height: 100px">
