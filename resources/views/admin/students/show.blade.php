...
?>
    ...
    <div class="row pt-3">
            ...
            <div class="card-box">
                <div class="student-profile-box text-center p-2">
                    <div class="avatar mb-1">
                        Passport :
                        <br/>
                        <a  href="{{ asset(($student->user->avatar) ? $student->user->avatar : "_dashboard/assets/images/users/avatar-1.jpg") }}">
                        <img src="{{ asset(($student->user->avatar) ? $student->user->avatar : "_dashboard/assets/images/users/avatar-1.jpg") }}"
                    ...
                    @if($student->biodata)
                       ...
                       <div class="avatar mb-1">
                        Signature  : 
                        <Br/>
                        <a  href="{{ $student->biodata->signature }}">
                        <img src="{{ $student->biodata->signature }}"
                         class="img-fluid img-rounded img-thumbnail">
        ...
        <div class="col-12 col-sm-8 col-md-9 table-responsive">
            ...
            class="card-box table table-bordered table-striped">
                ...
                <tr>
                    <th>Sex</th>
                    <td>
                           {{ ($student->biodata) ? $student->biodata->sex : "" }}
                    </td>
                </tr>
                  ...
                  <tr>
                    <th>Blood Group</th>
                    <td>
                           {{ ($student->biodata) ? $student->biodata->blood_group : "" }}
                    </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td>
                           {{ ($student->biodata) ? $student->biodata->place_of_birth : "" }}
                    </td>
                </tr>
              ...
              <!--   <tr>
                ...
                <tr>
                    <th>Institution</th>
                    <td>
                        {{ ($student->biodata) ? $student->biodata->institution : "" }}
                    </td>
                </tr>
                <tr>
                    <th>Email</th>
                ...
                <tr>
                    <th>Next of kin</th>
                    <td>
                        {{ ($student->biodata) ? $student->biodata->next_of_kin : "" }}
                    </td>
                </tr>
                <tr>
