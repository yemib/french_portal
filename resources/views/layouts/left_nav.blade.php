            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="{{ route("admin.student.index") }}">
                        <i class="mdi mdi-account-group text-info"></i> <span> Active Students</span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    $cards  =  Student::where('card_request',  'requested')->count();  ?>
                    <a href="{{ route("admin.student.card.requests") }}">

                        <i class="mdi mdi-account-group text-info"></i> <span> ID Card Request </span> <span style="color:red"> [{{ $cards }} ]</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route("admin.deactivated.students") }}">
                        <i class="mdi mdi-account-group text-info"></i> <span>Deactivated Students</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('student.results.dashboard') }}">
                        <i class="mdi mdi-clipboard-text text-white"></i> <span>Results</span>
                    </a>
                </li>
