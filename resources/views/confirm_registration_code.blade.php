            ...
            <div class="col-12 col-lg-10 offset-lg-1">
                <div class="account-box" style="max-width: inherit">
                    ...
                    <div class="account-content">
                        ...
                        <form method="POST" action="/confirm_registration_code" enctype="multipart/form-data">
                            @csrf
                 ...
                 <div id="register_personal_section">
                              ...
                              <h5 class="text-uppercase mb-3">Check REMITA RETRIEVAL REFERENCE  (RRR) Status</h5>
                                    <div class="row">
              ...
              <label  for="remita">  REMITA RETRIEVAL REFERENCE  (RRR)    </label>
                         <input class="form-control" type="text" name="rrr" id="remita" required placeholder="Remita Retrirval Reference">
                                        </div>
                      ...
                      <p>  No REMITA RETRIEVAL REFERENCE  (RRR)  ?  click Below to get one.  </p>
                      
                      <div class="form-group">
                                   <a  href="/registration_payment "> 
                                   
                                    <button class="btn btn-block btn-success waves-effect waves-light" type="submit">Registration Fee</button>
